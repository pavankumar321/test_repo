...
class tf_tree:
    ...
    def callback(self,msg):
        ...
        if self.times==0:
            ...
            #print(self.final_translation_x,'2nd value')
            #self.updatePose(self.translation_x,self.translation_y,self.rotation_z,self.rotation_w)
    ...
    def callback1(self,msg):
        ...
        #print(self.final_translation_x,'0 th value',self.translation_x)
        #print('outside callback1')
    ...
    def listener1(self):
        ...
        pub = rospy.init_node('robot_state_publisher', anonymous=True)
        rospy.Subscriber('/odom_combined', odomMsg, self.callback1)
        msg = String()
        msg.data = pub
    def tf_tree_create(self):
        ...
        t.header.frame_id = "/map"
        t.child_frame_id = "/odom"   
        print(self.final_translation_x,'1st value',self.translation_x)
        self.listener()
        self.listener1()
        print(self.final_translation_x,'2nd value',self.translation_x)
