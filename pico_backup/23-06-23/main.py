...
#    print("New message on topic {}".format(topic.decode('utf-8')))
    ...
    print(msg1['angular_dict']['z'])
    if msg1['angular_dict']['z'] ==0 and msg1['linear_dict']['x']==0:
        angular[0]=0
        linear[0]=0
        print('stop')
        ...
        print("stop")         
    elif msg1['linear_dict']['x'] > linear[0]:
        print('forward')
        linear[0]=msg1['linear_dict']['x']
    ...
    elif msg1['angular_dict']['z'] < angular[0]:
        print('right')
        angular[0]=msg1['angular_dict']['z']
