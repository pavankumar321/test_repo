...
ssid = 'vistan12345'
password = 'welcome1'
mqtt_server = '192.168.4.17'  #Replace with your MQTT Broker IP
...
#    print(msg1['linear_dict']['y'])
#    print(msg1['linear_dict']['z'])
#    print(msg1['angular_dict']['x'])
#    print(msg1['angular_dict']['y'])
