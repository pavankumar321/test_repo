...
#MQTT connect
def mqtt_connect():
    client = MQTTClient(client_id, mqtt_server, user=user_t, password=password_t, keepalive=600)
    client.connect()
            ...
            class Application2():
                ...
                async def action(self):
                    while True:
                        ...
                        client.publish(topic_pub, msg = json.dumps(data)
                                                        )
